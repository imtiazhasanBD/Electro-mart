...
const { state ,dispatch} = useContext(ProductsContext);
  ...
  return (
    ...
    <div>
       <div className="catagory bg-white flex  space-x-8 px-2 py-7 top-[56px] scrollbar-custom  overflow-auto">
       ...
       <div className="products grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-5 md:grid-cols-3 gap-9 p-4 z-20">
