    ...
    <div className='fixed bottom-0 right-0 w-full p-1 bg-white text-gray-700 font-bold z-10 sm:hidden border-2 border-gray-200'>
       ...
       {/*   <li>
        ...
        <li>
          <NavLink to={"/cart"}>
            <button className='relative'>
              ...
              <span className='px-1 bg-blue-500 text-white rounded-full text-xs absolute top-0 right-0'>{state.cartProducts.length}</span>}
            </button>
          </NavLink>
        </li>
        ...
        <li>
          <NavLink to={"/favs"}>
            <button className='relative'>
              ...
              <span className='px-1 bg-blue-500 text-white rounded-full text-xs absolute top-0 right-0'>{state.favoriteProducts.length}</span>}
            </button>
          </NavLink>
        </li>
        ...
        <li>
          <NavLink to={"/user"}>
          <button>
             {!state.avatar?   <HiOutlineUserCircle size={'1.5rem'}/> :   <img src= {state.avatar} className='w-6 h-6 rounded-full object-cover' />}
         </button>
          </NavLink>
        </li>
